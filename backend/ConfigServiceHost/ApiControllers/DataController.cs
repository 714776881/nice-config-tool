    ...
    public class DataController : ControllerBase
    {
        ...
        public ApiResponse ExeBatchSql(DalBatchForm form)
        {
            ...
            try
            {
                ...
                {
                    var sql = BuildSql(GetSqlTemplate(form.configFileName, form.sqlPath), item);
                    sqls.Add(sql);
                }
        ...
        {
            var sql = BuildSql(GetSqlTemplate(form.configFileName, form.sqlPath), form.data);
            return sql;
        }
        ...
        public static string BuildSql(string sqlTemplate, Dictionary<string, string> parameters)
        {
